...
import datetime
from frankzappa import calculate_time_elapsed_jupiter
...
def main():
    ...
    # Calculate the time elapsed on Jupiter and its delta
    time_elapsed_jupiter, delta_jupiter = calculate_time_elapsed_jupiter(birthdate)
    ...
    # Display the time elapsed on Jupiter and its delta
    print(f"{'Time Elapsed (Jupiter)':<30}: {time_elapsed_jupiter:.6f} seconds")
    print(f"{'Delta (Jupiter)':<30}: {delta_jupiter:.6f} seconds")
